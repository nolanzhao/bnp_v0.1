...
from bnp.algo.algo_03 import collection_name, search_target  # noqa
...
if _DATA_TODAY_EXISTS:
    n_days = get_recent_n_trade_days(n=15, include_today=True)
    print(n_days)
else:
    n_days = get_recent_n_trade_days(n=15, include_today=False)
    print(n_days)
...
save_record(L, algo="algo_03")

# step 4. send dingding
msg = {'date': today_str(), 'stocks': L, 'algo': '算法3: K线形态识别'}
